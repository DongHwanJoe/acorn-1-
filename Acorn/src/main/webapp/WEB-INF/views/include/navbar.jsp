...
<div class="chat_area">
	<div class="chatTop">
		...
		<svg id="max_process" xmlns="http://www.w3.org/2000/svg"
	...
	<div class="chat">
		...
		<div class="msg_box">
			...
			<svg id="msg_process" xmlns="http://www.w3.org/2000/svg"
...
/* 	console.log(sessionStorage.getItem("clientID"));	
	 ...
	 */
	 ...
	 let chatLogs = [];
	   ...
	   //페이지가 로드되면 세션 스토리지에서 채팅로그를 불러옵니다.
	   window.onload = function() {
	     const savedChatLogs = sessionStorage.getItem('chatLogs');
	     if (savedChatLogs) {
	       chatLogs = JSON.parse(savedChatLogs);
	       //불러온 채팅로그를 화면에 렌더링합니다.
...
//	    const data = JSON.stringify(result);
	    ...
	    event.data.text().then((jsonString) => {
	        ...
	        if(jsonObj.type=="message"){
		        ...
		        const id = jsonObj.id;
		      //받아온 메시지를 채팅로그 배열에 추가합니다.
	              chatLogs.push(id+": "+text);
	              //세션 스토리지에 채팅로그를 저장합니다.
